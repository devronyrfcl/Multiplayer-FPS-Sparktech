    ...
    namespace UI
    {
        ...
        public class Kit_OptionsResolution : Kit_OptionBase
        {
            ...
            public override void OnDropdownStart(TextMeshProUGUI txt, TMP_Dropdown dropdown)
            {
                ...
                {
                    //Create string
                    resolutions.Add(Screen.resolutions[i].width + "x" + Screen.resolutions[i].height + "@" + Screen.resolutions[i].refreshRateRatio.value.ToString() + "Hz");
                }
            ...
            public override void OnDropdowChange(TextMeshProUGUI txt, int newValue)
            {
                ...
                if (Screen.currentResolution.width != Screen.resolutions[newValue].width || Screen.currentResolution.height != Screen.resolutions[newValue].height || Screen.currentResolution.refreshRateRatio.value != Screen.resolutions[newValue].refreshRateRatio.value)
                {
                    //Set resoltuion
                    Screen.SetResolution(Screen.resolutions[newValue].width, Screen.resolutions[newValue].height, Screen.fullScreenMode, Screen.resolutions[newValue].refreshRateRatio);
                    //Save
