    ...
    namespace UI
    {
        ...
        public class Kit_OptionsButtonRemap : Kit_OptionBase
        {
            ...
            public override string GetDisplayName()
            {
                ...
                {
                    return action.name.Replace("Player/", "").Replace("UI/", "") + suffix;
                }
                else
                {
                    return overrideName + suffix;
                }
            }

            public override string GetHoverText()
            {
                return "Click here to remap this option!";
            }
